              ...
              <View style={s.heroIdentity}>
                ...
                <View style={s.heroText}>
                  ...
                  >
                    ...
                    categories used across all
                    salons in your platform.
                  </Text>
                </View>
              </View>
...
function CategoryModal({
  ...
  /*
    ...
    narrowMobile = width <= 390

    So Create + Update modal both use
    the same responsive layout.
  */

  const modalWidth = narrowMobile
    ? "96%"
    : mobile
    ? "94%"
    : "min(620px, 92%)";
  ...
  const bodyPadding = narrowMobile
    ? 14
    : mobile
    ? 18
    : 24;
  ...
  /*
    ...
    from getting cramped or clipped.
  */
  const stackFooter =
    narrowMobile;
...
const s = StyleSheet.create({
  ...
  /*
    375px:
    Cancel becomes full width.
  */
  modalSecondaryStacked: {
    width: "100%",
    flex: 0,
    minHeight: 46,
  },
  ...
  /*
    375px:
    Create / Update becomes full width.
  */
  modalPrimaryStacked: {
    width: "100%",
    flex: 0,
